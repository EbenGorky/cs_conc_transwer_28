...
def run_fun(name):
    ...
    for i in ev:
        Label(fram_run_fun,text = f"enter the value of variable {v[1][s]}",font = ('Times New Roman',20)).grid(row = u-1,column = 0)
...
def view_for():
    ...
    Button(fram_for,text = 'Select',command = abc,font = ('Times New Roman',13),padx = 20).grid(row = 3,column = 0)
...
def add_fun_gra():
    ...
    Button(fram_add_f_g,text = 'Add physic formula',font = ('Times New Roman',15)).grid(row = 1,column=0)
    Button(fram_add_f_g,text = 'Add graphical formula',font = ('Times New Roman',15)).grid(row = 2,column = 0)
    Button(fram_add_f_g,text = 'Back',command = intro,padx = 30,font = ('Times New Roman',15)).grid(row = 4,column = 0)
